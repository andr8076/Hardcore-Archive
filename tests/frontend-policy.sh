...
python3 "$ROOT/tests/restore-destination-race.py"
bash "$ROOT/tests/resource-utilization.sh"
bash "$ROOT/tests/resource-pool.sh"
bash "$ROOT/tests/image-performance-policy.sh"
bash "$ROOT/tests/image-calibration.sh"
bash "$ROOT/tests/png-validation.sh"
bash "$ROOT/tests/benchmark-corpus.sh"
python3 "$ROOT/tests/compressibility-routing.py"
...
bash "$ROOT/tests/video-encoder-capability.sh"
bash "$ROOT/tests/av1encode-dependency.sh"
bash "$ROOT/tests/video-software-real.sh"
...
bash "$ROOT/tests/intel-legacy-bootstrap.sh"
bash "$ROOT/tests/intel-legacy-selection.sh"
bash "$ROOT/tests/intel-legacy-production.sh"
