...
bash -n "$ROOT/lib/hardcore-archive-doctor-av1encode.sh"
bash -n "$ROOT/tests/av1encode-vendored-integration.sh"
bash -n "$ROOT/lib/intel-legacy-video.sh"
bash -n "$ROOT/lib/video-encoder-capabilities.sh"
bash -n "$ROOT/tests/video-software-real.sh"
